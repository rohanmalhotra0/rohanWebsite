...
const SOCIALS = [
  { name: 'LinkedIn', url: 'https://www.linkedin.com/in/rohanamal', icon: ICONS.LinkedIn },
  { name: 'GitHub', url: 'https://github.com/rohanmalhotra0', icon: ICONS.GitHub },
  { name: 'Instagram', url: 'https://www.instagram.com/rohanmalhotra0/', icon: ICONS.Instagram },
  { name: 'Mail', url: 'mailto:Rohanmalhotra8974@gmail.com', icon: ICONS.Mail },
];
...
export default function SocialMagnet() {
  ...
  return (
    <div className="social-magnet floating-social-dock fixed bottom-10 left-1/2 z-50 -translate-x-1/2">
      <TooltipProvider>
        <Dock>
          <DockIcon>
            <Tooltip>
